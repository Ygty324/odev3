import "./App.css";
import React from 'react' //state yi kulanmak için import ettik
...
function Liste(props){//PROPS ÖNEMLİ= VERİ İLETİŞİMİ İÇİN PROPS(VERİ DEĞİŞİMİ İÇİN=STATE)
  //props tanımlıyoruz(Liste içindeki ile buradaki isim aynı olmalı)
  return(//dönecek bütün elemanlar burada ekranda görünütlenecek
...
function App() {//kök birleşen App tir
    ...
    const[aramaMetni,setAramaMetni]=
    React.useState(localStorage.getItem("aranan")||"React");//LİFTİNG STATE YAPTIK BUNU  
  ...
  {
  baslik: "React Harika Yolculuk",
  url: "www.reactjourney.com",
  yazar: "Ayşe Demir",
  yorum_sayisi: 8,
  puan: 5,
  id: 5
...
{
  baslik: "Redux Temelleri",
  url: "www.reduxbasics.com",
  yazar: "Mehmet Can",
  yorum_sayisi: 5,
  puan: 4,
  id: 6
...
{
  baslik: "React Hooks Kullanımı",
  url: "www.reacthooksusage.com",
  yazar: "Zeynep Yılmaz",
  yorum_sayisi: 12,
  puan: 4.5,
  id: 7
...
{
  baslik: "TypeScript Entegrasyonu",
  url: "www.typescriptintegration.com",
  yazar: "Fatma Öztürk",
  yorum_sayisi: 10,
  puan: 4,
  id: 8
...
//STATE NİN ANLAMI SINAVDA GELEBİLİR
  ...
  return (//amaç bunun(App içerisinde) içerisindeki kodu azaltmak
  //listeyi çağırdık
